    ...
    <label className="label  flex   gap-x-2">
      ...
      <div className="flex flex-1  flex-wrap gap-2 sm:flex-nowrap">
        <input
          ...
          onChange={(e) => {
            setFilter((s: Record<string, unknown>) => ({
              ...s,
...
export const useGlobalMatchSorter = <T extends Record<string, unknown>>() =>
  useCallback((rows: Array<Row<T>>, ids: Array<IdType<T>>, query: string) => {
